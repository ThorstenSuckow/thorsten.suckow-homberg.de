...
date: "2026-01-05"
slug: "/high-level-overview-of-the-game-loop-architecture"
...
As part of a project assigment at [Tier University of Applied Sciences](https://www.hochschule-trier.de), I'm curently designing [a game framework based on C++ / OpenGL](https://garagecraft.games/helios).
...
<Tabs>
   ...
   ```
    ...
    // Gameplay Systeme (Aktualisierung der Physik etc.)
    Move2DSystem.update();
    ...
    ```
