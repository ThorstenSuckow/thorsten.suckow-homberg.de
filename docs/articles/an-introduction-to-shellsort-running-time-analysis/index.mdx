...
**Shellsort** ist ein Sortieralgorithmus, der nach *Donald Shell* benannt wurde. _Shell_ hat ihn 1959 in <BibRef name="She59" /> vorgestellt.
...
[Listing 1](#lst:1) eine Zählvariable $c4$ eingesetzt wird, die
...
es der Test-Code in [Listing 2](#lst:2) demonstriert. Dann wird überprüft, in welchen Bereichen sich $c3$ bewegt. Da jeder auf Vergleichsoperationen basierende Sortieralgorithmus zu der Laufzeitklasse $\Omega(n\ log\ n)$
