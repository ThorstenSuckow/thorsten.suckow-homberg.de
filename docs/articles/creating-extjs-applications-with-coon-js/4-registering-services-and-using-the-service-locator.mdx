...
The [previous part](/docs/articles/creating-extjs-applications-with-coon-js/configuration-details-and-plugins) of this article series provided an extended look at the various configuration options of a *coon.js*-application. This article assumes that you are familiar with the topics covered therein.
...
finished this article: [**Dependency Injection in JavaScript**](/docs/dependency-injection-in-javascript/article)