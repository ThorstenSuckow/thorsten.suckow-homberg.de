...
<ViewCamera />
  <figcaption style={{width:'100%',textAlign:'center',fontSize:'small'}}>
    ...
    <span>A wireframe teapot mesh with a view camera targeted at it (<a href="/threejs/viewcamera/build/index.html" target="_blank" rel="noopener">open in new tab</a>).</span>
  </figcaption>
</figure>
