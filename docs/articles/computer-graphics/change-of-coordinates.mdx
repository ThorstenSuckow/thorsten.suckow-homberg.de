...
$$
\vec{v}_\text{cam} = \boldsymbol{R}^T\ \boldsymbol{T}(-\vec{e}) \ \vec{v}_\text{world}
$$
...
$$
\begin{alignat*}{3}
\boldsymbol{R}^T\ \boldsymbol{T}(-\vec{e}) \ \vec{v}_\text{world}
&= \begin{pmatrix}
...
&= \begin{pmatrix}
  ...
  \\
&= \begin{pmatrix}
     (\vec{v}_\text{world} - \vec{e})\ \vec{c_1} \\
     (\vec{v}_\text{world} - \vec{e})\ \vec{c_2} \\
     (\vec{v}_\text{world} - \vec{e})\ \vec{c_3}\\
     1
     \end{pmatrix}\\
     \\
   &= \vec{v}_\text{cam}
