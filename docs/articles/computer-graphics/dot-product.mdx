...
[^collision]: [_Akenine-Möller et al._](https://www.realtimerendering.com) provide an exhaustive overview of the various techniques used with collision detection, see the freely available appendix of <BibRef name="RTR"/>, [Real-Time Rendering - Collision Detection](https://www.realtimerendering.com/Real-Time_Rendering_4th-Collision_Detection.pdf), on this subject
