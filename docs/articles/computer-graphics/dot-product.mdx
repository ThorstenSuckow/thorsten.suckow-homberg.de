...
The dot-product takes two vectors and returns the sum of the products of theior corresponding components.
Given two vectors
...
Since $0.98 > 0.76$[^cosrel], we conclude that $B$ is within the anglular limits defined by the FOV.
...
[^collision]: [_Akenine-Möller et al._](https://www.realtimerendering.com) offer a comprehensive overview of collision detection techniques, presented in the freely available appendix of <BibRef name="RTR"/>, [Real-Time Rendering - Collision Detection](https://www.realtimerendering.com/Real-Time_Rendering_4th-Collision_Detection.pdf), on this subject
