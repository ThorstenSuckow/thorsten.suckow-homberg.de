...
This allows us to express any local vectors in world coordinates:
...
For the transformation of a vector $[\vec{u}]_M$ into world coordinates, the following results:
...
## Reconstruction of the Rotated Vector
