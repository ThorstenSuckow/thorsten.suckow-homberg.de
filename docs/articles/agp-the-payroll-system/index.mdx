...
The Payroll System was introduced in Robert C. Martins Book **Agile Software Development** <BibRef name="ASD" /> and describes a batch Payroll System.
...
The source code is maintained at https://github.com/thorstensuckow/payroll. Branches are named after the use case:
 - [Branch "usecase1"](https://github.com/ThorstenSuckow/payroll/usecase1/) for [Use Case 1](./use-case-1-adding-a-new-employee.mdx)

The main branch will always reflect the source code from the most recent sprint. Once a Use Case is marked as "finished", code in this branch will not be changed anymore, and required code changes of the finished branch's code base will be implemented with the most recent sprint and. Tags and Versions will reflect this.
