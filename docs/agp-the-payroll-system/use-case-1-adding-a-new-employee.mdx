...
and an `Employee`-[**Entity**](../Glossary/softwaredesign.entity).
 - `Payroll` exists in the **Application Layer** and is the main entry point for interacting with the system, in the form
    of a traditional [**Facade**](../Glossary/softwaredesign.facade).
 - The [**Repository**](../Glossary/softwaredesign.repository) would be the `EmployeeRepository` and encapsulates the
