...
The **Application Layer** is an abstract functional division in a <GlosRef name="Layered Architecture" file="sa.layeredarchitecture" /> that serves as the interface between the client
