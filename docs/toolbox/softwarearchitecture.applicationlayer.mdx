...
**sub-systems** and **Services** existing in the lower layers of the system, such as the **<GlosRef name="Domain Layer" file="ddd.domainlayer" />** often supported by an **Infrastructure Layer**.
