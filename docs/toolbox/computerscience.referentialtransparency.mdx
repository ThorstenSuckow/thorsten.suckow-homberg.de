...
A more formal introduction to this topic is available from [_Sondergaard_](https://findanexpert.unimelb.edu.au/profile/13416-harald-sondergaard) and [_Sestoft_](https://www.itu.dk/people/sestoft/) in [Referential Transparency,
Definiteness and Unfoldability](https://www.cs.tufts.edu/~nr/cs257/archive/peter-sestoft/ref-trans.pdf):
...
the principle that any subexpression can be replaced by any other equal in value. "_
