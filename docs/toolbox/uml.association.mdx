...
We will take a deeper look at **Composition** and its usage in <GlosRef name="the according Toolbox entry" file="uml.composition" />, and refer to the example above when we discuss the child-parent relationships of **Compositions**.
